              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="list-group">
                    <a href="reg_courses.php"
                      class="list-group-item list-group-item-action">Bachelor Of Technology Honours Degree In
                      (<?php echo $department ?>)</a> <a
                      href="tec_courses.php"
                      class="list-group-item list-group-item-action">Certificate In Higher And Tertiary
                      Education (<?php echo $department ?>)</a>
                  </div>
                </div>
              </div>
            </div>
