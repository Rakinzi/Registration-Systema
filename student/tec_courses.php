...
$tecid = $finder->loadtecDept($_SESSION['email']);
?>
...
<li class="nav-item active">
    <a class="nav-link" href="selectcourses.php">
...
<!-- End of Sidebar -->
    ...
    <tbody>
<?php
$sqli = "SELECT * FROM tec_courses WHERE `tec_id` = '$tecid' AND part = '$part'";
$results = $conn->query($sqli);
if ($results) {
    while ($rows = $results->fetch_assoc()) {
        $uni_Code = $rows['tec_course_code'];
        $uni_courseName = $rows['tec_course_name'];
        $uni_credits = $rows['tec_credits'];
        echo '<tr>
